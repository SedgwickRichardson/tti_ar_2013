...
$(window).load(function () {
	function stickyInit()
	{
		...
		if(headerHeight < 200)
		{
			...
			{
				$('#breadcrumb').css({position: 'fixed', top: '49px', 'z-index': '899'});
   ...
   if($('body').hasClass('page-id-3636')){
	...
	else if($('body').hasClass('page-id-326') || $('body').hasClass('page-id-328')){
					...
					<div id="second-nav">
						<div id="second-nav-list">
							...
							<div id="second-link" style="float: right;">
								<a target="_blank" href="http://www.ttigroup.com/en/"><?php echo $langContent[ICL_LANGUAGE_CODE]['TTI Group']; ?></a> | 
								<a href="javascript:;" id="quickLinksBtn"><?php echo $homeContent[ICL_LANGUAGE_CODE]['Quick Links'];?></a> | 
								<div id="quickLinkBox">								
									<a target="_blank" href="http://www.ttigroup.com/en/investor_relations"><?php echo $langContent[ICL_LANGUAGE_CODE]['Investor Relations']; ?></a>
									...
									<a target="_blank" href="http://www.ttigroup.com/en/investor_relations/news/press_releases"><?php echo $homeContent[ICL_LANGUAGE_CODE]['Press release']; ?></a>
